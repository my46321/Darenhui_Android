...
public class OrderComplishmentActivity extends Activity {
    String order_id;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.order_comlishment);
        ...
        serviceContact.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dialog.showDialog(OrderComplishmentActivity.this);
            }
        });
        ...
        OkHttpUtils
                ...
                .execute(new UserCallback<OrderDetailJSON>() {
                    ...
                    public void onResponse(OrderDetailJSON response, int id) {
                        Glide.with(OrderComplishmentActivity.this).load(response.data.order_info.lesson_info.img).error(R.drawable.test).centerCrop().into(waitAcceptImage1);
                        Glide.with(OrderComplishmentActivity.this).load(response.data.order_info.avatar).bitmapTransform(new CirclePictureTransformation(OrderComplishmentActivity.this)).error(R.drawable.test).into(waitAcceptImage2);
