...
public class WaitAcceptActivity extends Activity {
    String order_id;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.wait_for_accept);
        ...
        serviceContact.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dialog.showDialog(WaitAcceptActivity.this);
            }
        });
        ...
        OkHttpUtils
                ...
                .execute(new UserCallback<OrderDetailJSON>() {
                    ...
                    public void onResponse(OrderDetailJSON response, int id) {
                        Glide.with(WaitAcceptActivity.this).load(response.data.order_info.lesson_info.img).error(R.drawable.test).centerCrop().into(waitAcceptImage1);
                        Glide.with(WaitAcceptActivity.this).load(response.data.order_info.avatar).bitmapTransform(new CirclePictureTransformation(WaitAcceptActivity.this)).error(R.drawable.test).into(waitAcceptImage2);
