...
import com.idarenhui.tool_android.ui.order.WaitEvaluateActivity;
...
public class MyRecyclerviewAdapter3 extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {
    ...
    public MyRecyclerviewAdapter3(List<OrderData> list,Context context) {
        this.list = list;
...
//        myViewHolder.viewText.setText(data.getViewText());
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.single_order3, parent, false);
