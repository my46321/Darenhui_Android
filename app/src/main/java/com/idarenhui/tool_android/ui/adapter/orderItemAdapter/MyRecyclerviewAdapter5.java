...
public class MyRecyclerviewAdapter5 extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {
    ...
    public MyRecyclerviewAdapter5(List<OrderData> list, Context context) {
        this.list = list;
...
//        myViewHolder.viewText.setText(data.getViewText());
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.single_order5, parent, false);
