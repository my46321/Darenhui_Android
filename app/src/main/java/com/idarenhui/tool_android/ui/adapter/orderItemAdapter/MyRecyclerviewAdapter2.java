...
public class MyRecyclerviewAdapter2 extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {
    ...
    public MyRecyclerviewAdapter2(List<OrderData> list,Context context) {
        this.list = list;
...
//        myViewHolder.viewText.setText(data.getViewText());
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.single_order2, parent, false);
