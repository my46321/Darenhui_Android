...
public class OrderCancelActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.order_waive);
        ...
        serviceContact.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dialog.showDialog(OrderCancelActivity.this);
            }
        });
        ...
        OkHttpUtils
                ...
                .execute(new UserCallback<OrderDetailJSON>() {
                    ...
                    public void onResponse(OrderDetailJSON response, int id) {
                        Glide.with(OrderCancelActivity.this).load(response.data.order_info.lesson_info.img).error(R.drawable.test).centerCrop().into(waitAcceptImage1);
                        Glide.with(OrderCancelActivity.this).load(response.data.order_info.avatar).bitmapTransform(new CirclePictureTransformation(OrderCancelActivity.this)).error(R.drawable.test).into(waitAcceptImage2);
