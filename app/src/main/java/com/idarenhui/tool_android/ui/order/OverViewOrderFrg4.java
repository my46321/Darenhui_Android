...
import com.idarenhui.tool_android.ui.adapter.orderItemAdapter.MyRecyclerviewAdapter4;
...
public class OverViewOrderFrg4 extends OverViewOrderFrg {
...
//        infoList.add(new OrderInfo("【茗礼】茶道美学系列课程", "已完成", R.drawable.test));
//        infoList.add(new OrderInfo("【茗礼】茶道美学系列课程", "已完成", R.drawable.test));
//        infoList.add(new OrderInfo("【茗礼】茶道美学系列课程", "已完成", R.drawable.test));
...
//            loadFromNet("0","6","10",UserInfo.token);
        adapter = new MyRecyclerviewAdapter4(infoList,getContext());
//        adapter.singleorderButton.setVisibility(View.GONE);
//        adapter.singleorderText2.setText("已完成");
        ...
        adapter.setOnItemClickLisitenter(new MyRecyclerviewAdapter.OnItemClickLisitenter() {
                   @Override
                    public void onItemClick(View v, int position) {
                       ...
                       Intent intent=new Intent(getActivity(), OrderComplishmentActivity.class);
