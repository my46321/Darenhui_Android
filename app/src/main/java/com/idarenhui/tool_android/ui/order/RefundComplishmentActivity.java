...
public class RefundComplishmentActivity extends Activity {
    String order_id;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        serviceContact.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dialog.showDialog(RefundComplishmentActivity.this);
            }
        });
        ...
        OkHttpUtils
                ...
                .execute(new UserCallback<OrderDetailJSON>() {
                    ...
                    public void onResponse(OrderDetailJSON response, int id) {
                        Glide.with(RefundComplishmentActivity.this).load(response.data.order_info.lesson_info.img).error(R.drawable.test).centerCrop().into(waitAcceptImage1);
                        Glide.with(RefundComplishmentActivity.this).load(response.data.order_info.avatar).bitmapTransform(new CirclePictureTransformation(RefundComplishmentActivity.this)).error(R.drawable.test).into(waitAcceptImage2);
