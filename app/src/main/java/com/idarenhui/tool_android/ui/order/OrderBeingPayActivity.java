...
public class OrderBeingPayActivity extends Activity {
    String order_id;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.order_being_pay);
        ...
        serviceContact.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dialog.showDialog(OrderBeingPayActivity.this);
            }
        });
        ...
        OkHttpUtils
                ...
                .execute(new UserCallback<OrderDetailJSON>() {
                    ...
                    public void onResponse(OrderDetailJSON response, int id) {
                        Glide.with(OrderBeingPayActivity.this).load(response.data.order_info.lesson_info.img).error(R.drawable.test).centerCrop().into(waitAcceptImage1);
                        Glide.with(OrderBeingPayActivity.this).load(response.data.order_info.avatar).bitmapTransform(new CirclePictureTransformation(OrderBeingPayActivity.this)).error(R.drawable.test).into(waitAcceptImage2);
