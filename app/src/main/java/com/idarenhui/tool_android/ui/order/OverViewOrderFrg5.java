...
import com.idarenhui.tool_android.ui.adapter.orderItemAdapter.MyRecyclerviewAdapter5;
...
public class OverViewOrderFrg5 extends OverViewOrderFrg {
...
//        infoList.add(new OrderInfo("【茗礼】茶道美学系列课程", "已退款", R.drawable.test));
//        infoList.add(new OrderInfo("【茗礼】茶道美学系列课程", "已退款", R.drawable.test));
//        infoList.add(new OrderInfo("【茗礼】茶道美学系列课程", "已退款", R.drawable.test));
...
//            loadFromNet("0","7","10",UserInfo.token);
        adapter = new MyRecyclerviewAdapter5(infoList,getContext());
...
//        adapter.singleorderButton.setVisibility(View.GONE);
//        adapter.singleorderText2.setText("已退款");
        ...
        adapter.setOnItemClickLisitenter(new MyRecyclerviewAdapter.OnItemClickLisitenter() {
                   @Override
                    public void onItemClick(View v, int position) {
                       ...
                       Intent intent=new Intent(getActivity(), RefundComplishmentActivity.class);
